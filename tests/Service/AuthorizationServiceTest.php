...
class AuthorizationServiceTest extends TestCase
{
    public function testGetAuthorizationUri(): void
    {
        ...
        $issuerMetadata->getAuthorizationEndpoint()->willReturn('https://foo-endpoint?test=test');

        static::assertSame('https://foo-endpoint?test=test&client_id=clientId&scope=openid&response_type=code&redirect_uri=redirect_uri_1', $service->getAuthorizationUri($openIdClient->reveal()));
    }
